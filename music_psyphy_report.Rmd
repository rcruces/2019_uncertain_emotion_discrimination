...
BAD NEWS, if I take out the nb0 the effect is less strong for discriminating groups.  
IT IS SO BAD THAT IT LOOKS LIKE CONFFETIS, bahahahaha.
...
plot(d$LDA2,d$LDA3,col="white",bg=c("red","green","blue","orange")[d$type],pch=21,cex=2.5)
